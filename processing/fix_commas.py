...
# column is only ever one of the hardcoded values below, and otherwise
# combining the columns between the payee (which usually has an extra comma)
# and the category. This script should only be run on the unaltered
