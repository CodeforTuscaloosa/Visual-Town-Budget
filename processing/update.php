...
<html>
<head>
  <link type="text/css" rel="stylesheet" href="{{ site.baseurl }}/css/update.css">
  <link type="text/css" rel="stylesheet" href="{{ site.baseurl }}/css/global.css">
  <script type="text/javascript" src ="{{ site.baseurl }}/js/lib/jquery/jquery-1.9.1.min.js"></script>
  <script type="text/javascript" src ="{{ site.baseurl }}/js/lib/bootstrap-file.js"></script>
